...
=======
		<div class="flex justify-center items-center">
			<div class="flex items-center md:self-center text-3xl font-medium px-0.5">
				{$i18n.t('Apps')}
				<!-- <div class="flex self-center w-[1px] h-6 mx-2.5 bg-gray-50 dark:bg-gray-850" />
				<span class="text-lg font-medium text-gray-500 dark:text-gray-300"
					>{filteredModels.length}</span
...
=======
							class=" rounded-md object-cover {model.is_active
>>>>>>> dfef03c8e (同步远程)
								? ''
...
=======
					<div class=" self-center mr-2 font-medium line-clamp-1">{$i18n.t('Import Apps')}</div>
>>>>>>> dfef03c8e (同步远程)
...
=======
					<div class=" self-center mr-2 font-medium line-clamp-1">{$i18n.t('Export Apps')}</div>
>>>>>>> dfef03c8e (同步远程)
