<script lang="ts">
	...
	const WEBUI_BASE_URL = 'http://your-server-address:port'; // Update this line with your server's address and port
...
{#if loaded}
	...
	<div class="flex flex-col gap-1 my-1.5">
		<!-- <div class="flex justify-between items-center">
			<div class="flex items-center md:self-center text-xl font-medium px-10.5">
				{$i18n.t('GPTs')}
...
<!-- 
	...
	{#if !$config?.features.enable_community_sharing}
		<div class=" my-16">
			...
			>
				<div class=" self-center">
					<div class=" font-semibold line-clamp-1">{$i18n.t('Discover a mask')}</div>
