    ...
    if mode == 'race':
        ...
        if train_type == 'finetune_student':
            ...
            argv += [
                ...
                '--alpha', '0.7',
                '--T', '4',
                '--teacher_prediction', f'/home/jingxu/project/PKD/data/outputs/KD/{task_name}/{task_name}_normal_kd_teacher_12layer_result_summary.pkl',
            ]
            ...
            argv += [
                ...
                '--beta', '500',
                '--T', '4',
                '--teacher_prediction', f'/home/jingxu/project/PKD/data/outputs/KD/{task_name}/{task_name}_patient_kd_teacher_12layer_result_summary.pkl',
