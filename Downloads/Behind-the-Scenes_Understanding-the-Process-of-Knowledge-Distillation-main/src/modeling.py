...
class BertForSequenceClassificationEncoder(BertPreTrainedModel):
    def __init__(self, config, output_all_encoded_layers='kd', num_hidden_layers=None, fix_pooler=False):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        if self.output_all_encoded_layers == 'kd.cls':
        ...
        elif self.output_all_encoded_layers == 'ckd':
            full_output, pooled_output = self.bert(input_ids, token_type_ids, attention_mask, output_all_encoded_layers=True)
    ...
    def getKnowledge(self, input_ids, token_type_ids, attention_mask):
        knowledge, _ = self.bert(input_ids, token_type_ids, attention_mask)
        return knowledge[-1]

    def ckd(self, input_ids, token_type_ids, attention_mask):
        full_output, pooled_output = self.bert(input_ids, token_type_ids, attention_mask,
                                               output_all_encoded_layers=True)
        return full_output
