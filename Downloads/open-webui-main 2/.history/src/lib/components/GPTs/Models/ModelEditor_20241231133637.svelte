<script lang="ts">
	...
	import Knowledge from '$lib/components/GPTs/Models/Knowledge.svelte';
	import ToolsSelector from '$lib/components/GPTs/Models/ToolsSelector.svelte';
	import FiltersSelector from '$lib/components/GPTs/Models/FiltersSelector.svelte';
	import ActionsSelector from '$lib/components/GPTs/Models/ActionsSelector.svelte';
	import Capabilities from '$lib/components/GPTs/Models/Capabilities.svelte';
