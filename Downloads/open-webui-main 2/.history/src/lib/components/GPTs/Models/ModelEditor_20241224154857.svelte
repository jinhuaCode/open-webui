<script lang="ts">
	...
	import Knowledge from '$lib/components/Masks/Models/Knowledge.svelte';
	import ToolsSelector from '$lib/components/Masks/Models/ToolsSelector.svelte';
	import FiltersSelector from '$lib/components/Masks/Models/FiltersSelector.svelte';
	import ActionsSelector from '$lib/components/Masks/Models/ActionsSelector.svelte';
	import Capabilities from '$lib/components/Masks/Models/Capabilities.svelte';
				...
				<div class="w-full">
					...
					<div class="my-1">
						...
						{#if info.meta.description !== null}
							<Textarea
								...
								placeholder={$i18n.t('Add a short description about what this mask does')}
								rows={3}
					...
					<div class="my-2">
						<div class="flex w-full justify-between">
							<div class=" self-center text-sm font-semibold">{$i18n.t('GPTs Params')}</div>
						</div>
						...
						<div class="mt-2">
							<div class="my-1">
								...
								<div>
									<Textarea
										className=" text-sm w-full bg-transparent outline-none resize-none overflow-y-hidden "
										placeholder={`Write your mask system prompt content here\ne.g.) You are Mario from Super Mario Bros, acting as an assistant.`}
										rows={4}
