		...
		<div class=" flex flex-1 items-center w-full space-x-2">
			<div class="flex flex-1 items-center">
				...
				<input
					...
					placeholder={$i18n.t('Search Masks')}
				/>
			</div>
	...
	{#if $user?.role === 'admin'}
		<div class=" flex justify-end w-full mb-3">
			<div class="flex space-x-1">
				...
				>
					<div class=" self-center mr-2 font-medium line-clamp-1">{$i18n.t('Import Masks')}</div>
				...
				>
					<div class=" self-center mr-2 font-medium line-clamp-1">{$i18n.t('Export Masks')}</div>
